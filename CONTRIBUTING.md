...
To get started, make sure you have [Node](https://nodejs.org) version 22 and [PNPM](https://pnpm.io/) verson 10 installed. Install dependencies and build the libraries with:
