import { Container, Video as VideoImpl, Text, abortableEffect, withOpacity, searchFor, } from '@pmndrs/uikit';
...
export class Video extends Container {
    ...
    constructor(inputProperties, initialClasses, config) {
        ...
        super.add((this.video = new VideoImpl(undefined, undefined, {
            defaults: imageDefaults,
            defaultOverrides: {
                '*': {
                    borderColor: colors.border,
        ...
        super.add((this.controls = new VideoControls(undefined, undefined, {
            defaultOverrides: {
                '*': {
                    borderColor: colors.border,
                },
...
export class VideoControls extends Container {
    constructor(inputProperties, initialClasses, config) {
        super(inputProperties, initialClasses, {
