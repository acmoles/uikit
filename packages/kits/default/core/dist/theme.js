...
import { isDarkMode, readReactive, withOpacity, componentDefaults as baseComponentDefaults, imageDefaults as baseImageDefaults, inputDefaults as baseInputDefaults, textDefaults as baseTextDefaults, contentDefaults as baseContentDefaults, } from '@pmndrs/uikit';
...
export const theme = signal(defaultThemes.default);
export function setTheme(newTheme) {
    theme.value = newTheme;
}
function computeThemeProperty(key) {
    return ((isDarkMode.value ? readReactive(theme.value.dark?.[key]) : undefined) ??
        readReactive(theme.value[key]));
}
export const colors = {};
